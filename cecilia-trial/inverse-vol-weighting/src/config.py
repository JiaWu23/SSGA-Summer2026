...
class PortfolioConfig:
    ...
    # Capital weighting across selected assets: "equal" (default, baseline
    # behavior, bit-for-bit identical) or "inverse_vol" (risk-balanced:
    # budget proportional to 1 / trailing 26w vol among the week's picks).
    weighting_scheme: str = "equal"
    # Floor on annualized vol used in inverse-vol budgets (guards div-by-tiny).
    inv_vol_floor_ann: float = 0.02
